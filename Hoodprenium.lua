...
local Window = Fluent:CreateWindow({Title = "iria Hub [Version:V1]",SubTitle = "| By hood_prenium",TabWidth = 155,Size = UDim2.fromOffset(555, 320),Acrylic = false,Theme = "Light",MinimizeKey = Enum.KeyCode.End})
...
ToggleButton.Image = "rbxassetid://93161054586708"
...
local Tabs = {
  ...
  Settings = Window:AddTab({Title = "Cài Đặt", Icon = "rbxassetid://117394884545382"}),
  Main = Window:AddTab({Title = "Cày", Icon = "home"}),
  Melee = Window:AddTab({Title = "Võ Thuật", Icon = "rbxassetid://117394884545382"}),
  Quests = Window:AddTab({Title = "Vật Phẩm Cày", Icon = "rbxassetid://117394884545382"}),
  SeaEvent = Window:AddTab({Title = "Biển", Icon = "rbxassetid://117394884545382"}),
  Mirage = Window:AddTab({Title = "Đảo Bí Ẩn/V4", Icon = "rbxassetid:/117394884545382"}),
  ...
  Misc = Window:AddTab({Title = "Linh Tinh", Icon = "rbxassetid://117394884545382"})
}
