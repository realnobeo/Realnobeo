...
local FolderName = "iria Hub | main"
...
local v1 = Window:MakeTab({
    Title = "Status/Server",
    Icon = "rbxassetid://83401629791288"
})
...
-- =========================================================
-- AUTO FISHING SYSTEM (Ported from iria Hub)
-- =========================================================
        ...
        pcall(function()
            while wait(Sec) do
                if _G.Auto_Rainbow_Haki then
                    -- Copy logic Rainbow Haki từ file iria Hub.txt (dòng 2058-2154) vào đây nếu cần
